...
import ncrc.nise.ajou.ac.kr.opa.data.DBHelper;
import ncrc.nise.ajou.ac.kr.opa.fragment.ExerciseRecommenderFragment;
...
import ncrc.nise.ajou.ac.kr.opa.myavatar.UserSettingsActivity;
import ncrc.nise.ajou.ac.kr.opa.service.PersistentService;
import ncrc.nise.ajou.ac.kr.opa.service.RestartService;
...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks
{
    ...
    private class InitializationRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "DB 파일을 생성할 수 없습니다.", Toast.LENGTH_LONG).show();
            }
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        if (position == 0) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.container, ExerciseRecommenderFragment.newInstance(position + 1))
                    .commit();
        } else if (position == 3) {
            fragmentManager.beginTransaction()

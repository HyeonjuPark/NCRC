...
public class RecommendedExercisesActivity extends ActionBarActivity {
    ...
    private TextView textViewBreakfastlistTitle;
    private TextView textViewLunchlistTitle;
    private TextView textViewDinnerlistTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String currDate = "2016-01-04";//intent.getExtras().getString("currDate");
        final String type = "breakfast";//intent.getExtras().getString("type");
        final String place = intent.getExtras().getString("place");
        final String strength = intent.getExtras().getString("strength");
        ...
        textViewBreakfastlistTitle = (TextView)findViewById(R.id.textViewBreakfastlistTitle);
        textViewLunchlistTitle = (TextView)findViewById(R.id.textViewLunchlistTitle);
        textViewDinnerlistTitle = (TextView)findViewById(R.id.textViewDinnerlistTitle);
        textViewBreakfastlistTitle.setText("아침 식사");
        textViewLunchlistTitle.setText("점심 식사");
        textViewDinnerlistTitle.setText("저녁 식사");
...
//        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder alert = new AlertDialog.Builder(RecommendedExercisesActivity.this);
                alert.setTitle("삭제");
        ...
        buttonAddFood.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder ab = new AlertDialog.Builder(RecommendedExercisesActivity.this);
                ab.setTitle("음식 카테고리");
                ...
                // 전체 레이아웃
                LinearLayout layout = new LinearLayout(RecommendedExercisesActivity.this);
                layout.setOrientation(LinearLayout.VERTICAL);
                layout.setGravity(Gravity.CENTER);

                // 그 안의 레이아웃 1
                LinearLayout foodNameLayout = new LinearLayout(RecommendedExercisesActivity.this);
                foodNameLayout.setOrientation(LinearLayout.HORIZONTAL);
                TextView textViewFoodname = new TextView(RecommendedExercisesActivity.this);
                textViewFoodname.setText("음식 이름 : ");
                final EditText editTextFoodname = new EditText(RecommendedExercisesActivity.this);
                editTextFoodname.setEms(5);
                foodNameLayout.addView(textViewFoodname);
                foodNameLayout.addView(editTextFoodname);

                // 그 안의 레이아웃 2
                LinearLayout kcalLayout = new LinearLayout(RecommendedExercisesActivity.this);
                kcalLayout.setOrientation(LinearLayout.HORIZONTAL);
                TextView textViewKcal = new TextView(RecommendedExercisesActivity.this);
                textViewKcal.setText("칼로리(kcal) : ");
                final EditText editTextKcal = new EditText(RecommendedExercisesActivity.this);

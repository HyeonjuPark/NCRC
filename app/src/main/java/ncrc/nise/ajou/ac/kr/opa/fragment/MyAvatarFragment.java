...
public class MyAvatarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewBMI = (TextView) rootView.findViewById(R.id.editTextHeight);
        textViewObesityStatus = (TextView) rootView.findViewById(R.id.editTextWeight);
        textViewDailyBMR = (TextView) rootView.findViewById(R.id.editTextAge);

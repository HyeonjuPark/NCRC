package ncrc.nise.ajou.ac.kr.opa.myavatar;
...
public class UserSettingsActivity extends ActionBarActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewHeight = (TextView) findViewById(R.id.textViewTitleExerciseRecommender);
        textViewWeight = (TextView) findViewById(R.id.textViewTitlePlace);
        textViewAge = (TextView) findViewById(R.id.textViewTitleAge);
